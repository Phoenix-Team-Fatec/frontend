  ...
  return (
    <Card className="border border-gray-200 hover:shadow-md transition-shadow duration-200">
      <CardContent className="p-4">
        ...
        <div className={`text-xs mt-2 font-medium py-1 px-2 rounded-full inline-block ${
          task.tarefa_status ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
        }`}>
